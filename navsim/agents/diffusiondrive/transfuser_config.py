...
class TransfuserConfig:
    ...
    plan_anchor_path: str = "/app/DiffusionDrive/data/anchors/kmeans_navsim_traj_20.npy"
    ...
    # Stronger defaults to increase MoE specialization/impact.
    ...
    moe_router_z_loss_coef: float = 5e-3
